(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function MT7(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar color=\"secondary\">\n    <ion-title>\n      Data Covid19\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar color=\"secondary\">\n      <ion-title size=\"large\">Covid19 Data</ion-title>\n    </ion-toolbar>\n  </ion-header>  \n  <ion-row class=\"ion-text-center align-items-center\">\n    <ion-col size=\"12\">\n      <ion-text><h4>ADD RECORD</h4></ion-text>\n    </ion-col> \n  </ion-row>\n  <ion-row>\n    <ion-col size=\"12\" >\n      <ion-item>\n        <ion-input [(ngModel)]=\"addrecord.name\" placeholder=\"Name\"></ion-input>\n      </ion-item>\n    </ion-col>\n    <ion-col size=\"12\">\n      <ion-item>\n        <ion-input [(ngModel)]=\"addrecord.age\" placeholder=\"Age\"></ion-input>\n      </ion-item>\n    </ion-col>\n    <ion-col size=\"12\">\n      <ion-item>\n        <ion-input [(ngModel)]=\"addrecord.address\" placeholder=\"Address\"></ion-input>\n      </ion-item>\n    </ion-col>\n    <ion-col size=\"12\" >\n      <ion-select [(ngModel)]=\"addrecord.type\" placeholder=\"Select Gender\">\n        <ion-select-option value=\"male\">Male</ion-select-option>\n        <ion-select-option value=\"female\">Female</ion-select-option>\n      </ion-select>\n    </ion-col>\n    <ion-col size=\"12\" >\n      <ion-select [(ngModel)]=\"addrecord.loc\" placeholder=\"Select Location\">\n        <ion-select-option value=\"jakarta\">Jakarta</ion-select-option>\n        <ion-select-option value=\"sumatera\">Sumatera</ion-select-option>\n        <ion-select-option value=\"kalimantan\">Kalimantan</ion-select-option>\n      </ion-select>\n    </ion-col>\n    <ion-col size=\"10\" offset=\"1\">\n      <ion-button expand=\"block\" color=\"success\" (click)=\"AddRecord(addrecord.name, addrecord.age, addrecord.address, addrecord.type, addrecord.loc)\">Add</ion-button>\n    </ion-col>\n  </ion-row>  \n  <!-- <ion-row>    \n    <ion-col size=\"12\">        \n        <h4>\n          Your last records\n        </h4>\n        <ion-row  >       \n          <ion-col size=\"3\">\n            Age\n          </ion-col>\n          <ion-col size=\"5\">\n            Name\n          </ion-col>\n          <ion-col size=\"4\" class=\"ion-text-center align-items-center\">\n            Action\n          </ion-col>\n        </ion-row>\n        <ion-row  class=\"align-items-center\" *ngFor=\"let record of records; let i = index\">\n          <ion-col  size=\"3\">             \n            <ion-note *ngIf=\"record.type == 'male'\" color=\"success\">$ {{record.amount}}</ion-note>\n            <ion-note *ngIf=\"record.type == 'female'\" color=\"danger\">$ {{record.amount}}</ion-note>\n          </ion-col>\n          <ion-col size=\"5\">\n            <ion-note>{{record.description}}</ion-note>\n          </ion-col>\n          <ion-col size=\"4\">\n            <ion-button size=\"small\" color=\"primary\" (click)=\"UpdateRecord(record.id, record.type, record.name, record.age)\"><ion-icon name=\"create-outline\"></ion-icon></ion-button>\n            <ion-button size=\"small\" color=\"danger\" (click)=\"DeleteRecord(record.id)\"><ion-icon name=\"trash-outline\"></ion-icon></ion-button>\n          </ion-col>\n        </ion-row>\n    </ion-col>\n  </ion-row> -->\n</ion-content>";
      /***/
    },
      ...
      var Tab1Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngOnInit() {
            ...
            this.firestore.collection('/Covid/').snapshotChanges().subscribe(function (res) {
              if (res) {
                _this2.records = res.map(function (e) {
                  return {
                    id: e.payload.doc.id,
          ...
          value: function getPicture(sourceType) {
            ...
            _ionic_native_camera__WEBPACK_IMPORTED_MODULE_7__["Camera"].getPicture(cameraOptions).then(function (captureDataUrl) {
              _this3.captureDataUrl = 'data:image/jpeg;base64' + captureDataUrl;
            }, function (err) {
              console.error();
            });
          }
          ...
          key: "AddRecord",
          value: function AddRecord(name, age, address, type, loc) {
            var _this4 = this;
            ...
            this.firestore.collection('/Covid/').add(this.addrecord).then(function () {
              _this4.addrecord = {
                name: '',
                age: null,
                address: '',
          ...
          key: "UpdateRecord",
          value: function UpdateRecord(id, name, age, address, type, loc) {
