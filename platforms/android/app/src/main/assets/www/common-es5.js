    ...
    function GxS6(module, __webpack_exports__, __webpack_require__) {
      ...
      var UpdaterecordComponent = /*#__PURE__*/function () {
        ...
        _createClass(UpdaterecordComponent, [{
          ...
          key: "UpdateRecord",
          value: function UpdateRecord(name, age, address, type, loc) {
            var _this = this;

            var updaterecord = {};
            updaterecord['name'] = name, updaterecord['age'] = age, updaterecord['address'] = address, updaterecord['type'] = type, updaterecord['loc'] = loc, this.firestore.doc('/Covid/' + this.id).update(updaterecord).then(function () {
