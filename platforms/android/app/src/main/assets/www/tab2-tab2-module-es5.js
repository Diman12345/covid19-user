(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab2-tab2-module"], {
    ...
    function JZ9U(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_updaterecord_updaterecord_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var Tab2Page = /*#__PURE__*/function () {
        function Tab2Page(firestore, modalCOntroller) {
        ...
        _createClass(Tab2Page, [{
          ...
          value: function ngOnInit() {
            ...
            this.firestore.collection('/Covid/').snapshotChanges().subscribe(function (res) {
              if (res) {
                _this.records = res.map(function (e) {
                  return {
                    id: e.payload.doc.id,
