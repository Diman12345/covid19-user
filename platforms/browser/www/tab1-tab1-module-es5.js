(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    /***/
    function GxS6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UpdaterecordComponent", function () {
        return UpdaterecordComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_updaterecord_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./updaterecord.component.html */
      "pE6I");
      /* harmony import */


      var _updaterecord_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./updaterecord.component.scss */
      "sX3f");
      /* harmony import */
      ...
      var UpdaterecordComponent = /*#__PURE__*/function () {
        function UpdaterecordComponent(firestore, modalController) {
          _classCallCheck(this, UpdaterecordComponent);

          this.firestore = firestore;
          this.modalController = modalController;
        }

        _createClass(UpdaterecordComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "UpdateRecord",
          value: function UpdateRecord(type, description, amount) {
            var _this2 = this;

            var updaterecord = {};
            updaterecord['type'] = type, updaterecord['description'] = description, updaterecord['amount'] = amount, this.firestore.doc('/Records/' + this.id).update(updaterecord).then(function () {
      ...
      UpdaterecordComponent.ctorParameters = function () {
        return [{
      ...
      UpdaterecordComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function Mzl2(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_updaterecord_updaterecord_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../components/updaterecord/updaterecord.component */
      "GxS6");
      /* harmony import */
      ...
      var _ionic_native_camera__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @ionic-native/camera */
      "c0I4");

      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(firestore, modalCOntroller) {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngOnInit() {
            ...
            this.firestore.collection('/Records/').snapshotChanges().subscribe(function (res) {
              if (res) {
                _this3.records = res.map(function (e) {
                  return {
                    id: e.payload.doc.id,
          ...
          value: function getPicture(sourceType) {
            ...
            _ionic_native_camera__WEBPACK_IMPORTED_MODULE_7__["Camera"].getPicture(cameraOptions).then(function (captureDataUrl) {
          ...
          key: "AddRecord",
          value: function AddRecord(type, description, amount) {
            var _this5 = this;
            ...
            this.firestore.collection('/Records/').add(this.addrecord).then(function () {
              _this5.addrecord = {
                type: '',
                description: '',
                amount: null
          ...
          key: "UpdateRecord",
          value: function UpdateRecord(id, type, description, amount) {
    ...
    /***/
    function c0I4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function (_super) {
        ...
        CameraOriginal.prototype.getPicture = function (options) {
          return Object(_ionic_native_core__WEBPACK_IMPORTED_MODULE_0__["cordova"])(this, "getPicture", {
            "callbackOrder": "reverse"
          }, arguments);
        };

        CameraOriginal.prototype.cleanup = function () {
          return Object(_ionic_native_core__WEBPACK_IMPORTED_MODULE_0__["cordova"])(this, "cleanup", {
            "platforms": ["iOS"]
          }, arguments);
        };
    ...
    /***/
    function pE6I(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function sX3f(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function tmrb(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_updaterecord_updaterecord_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../components/updaterecord/updaterecord.component */
      "GxS6");
